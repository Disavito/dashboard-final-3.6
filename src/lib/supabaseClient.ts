...
// Eliminamos el slash final de la URL para evitar problemas de concatenación
const supabaseUrl = (import.meta.env.VITE_SUPABASE_URL || 'https://n8n-supabase.mv7mvl.easypanel.host').replace(/\/$/, '');
...
export const supabase = createClient(supabaseUrl, supabaseAnonKey, {
  ...
  global: {
    headers: {
      'Accept': 'application/json', // Forzamos Accept general para evitar 406 en proxies estrictos
    },
  },
});
